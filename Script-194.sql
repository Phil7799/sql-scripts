...
(select CreatedOn, hours, created_on, VehicleType, driver_email, Trip_Type, City, Country, PickupLatitude, 
PickupLongitude, CorporateID, MobileNumber, ' ' as EstimatedDistanceFromRider,
